...
To run the Lockwood problem make sure to download the source code from [Robert Gramacy's Surrogates Website](https://bobby.gramacy.com/surrogates/) and to compile it. The `RUNLOCK_PATH` in `problems/lockwood.py` should be modified accordingly.
